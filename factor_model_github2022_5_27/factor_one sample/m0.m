function [pai1,FDP_hat,NDR,true_FDP,R,S] = ...
    m0(Y,berlii)
...
%   Call description:
%   m0(Y,berlii): call other functions, such as solvet_hat00.m, solveW.m,
...
[t_fdr_hat, T_k, pai1, sigma_hat] = solvet_hat00(Y,W0_hat,T0_hat);
